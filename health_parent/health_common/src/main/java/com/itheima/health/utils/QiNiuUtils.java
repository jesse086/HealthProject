...
public class QiNiuUtils {
    ...
    private static final String ACCESSKEY = "aYcAkEt_o5XPe2pnZZ_RqhjghwMD8XCu3yHfU_o5";
    private static final String SECRETKEY = "QH8T8VjsjTkGXSLoUB7A2fXNIGufhswCzecY5z8A";
    private static final String BUCKET = "sz10";
    public static final String DOMAIN = "http://qmpisufjf.hn-bkt.clouddn.com/";
    private static long logTimestemp4Toke = 0l;
    private static String token = null;

    public static void main(String[] args) {
        uploadFile("C:\\Users\\acer\\Desktop\\11.jpg","new1.jpg");
